...
- (void)viewDidLoad {
    ...
    urlTextView.text = @"1、首先下载苹果电脑端应用程序http://www.helloted.com/mac_app/";
    ...
    installedLabel.text = @"2、电脑端安装程序并且打开,如下图:";
    ...
    refreshLabel.text = @"3、首页左上角按钮进行刷新，搜索电脑端的应用;";
    ...
    findLabel.text = @"4、查找到电脑端的应用,获得如下按钮界面:";
...
{
    NSString *text = @"1、首先点击复制下载苹果电脑端应用程序 http://www.helloted.com/mac_app/";
